...
release() {
    ...
    gcc -o bin/release/intp object/release/main.o object.release/data.o object/release/lexer.o object/release/parser.o object/release/core.o -s -O3
...
debug() {
    ...
    gcc -o bin/debug/intp object/debug/main.o object/debug/lexer.o object/debug/data.o object/debug/parser.o object/debug/core.o
